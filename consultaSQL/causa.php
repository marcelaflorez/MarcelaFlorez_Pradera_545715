...
try {
    $objDB = new causa('localhost', 'bddesercion', 'root', 'Sena2014');
...
<body><center><form method="post" action="inser-causa.php" name="form">
 <input type="submit" value="insertar campo" ></form>
<form method="post" action="elim-causa.php" name="form">
<input type="submit" value="eliminar campo" ></form>
 <form method="post" action="modi_causa.php" name="form">
...
<tr><td><?php echo $row['cod_causa']?></td><td><?php echo $row['des_causa']?></td>
