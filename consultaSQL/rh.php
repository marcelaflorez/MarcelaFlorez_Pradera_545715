...
try {
    $objDB = new rh('localhost', 'bddesercion', 'root', 'Sena2014');
...
<body><center><form method="post" action="inser-rh.php" name="form">
    <input type="submit" value="insertar campo"> </form>   
    <form method="post" action="elim-rh.php" name="form">
    <input type="submit" value="eliminar campo"> </form>
    <form method="post" action="modi-rh.php" name="form">
...
<tr><td><?php echo $row['cod_rh']?></td><td><?php echo $row['des_rh']?></td>
</tr>
<?php endforeach ?>
</table>
</center>
