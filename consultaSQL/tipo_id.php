...
try {
    $objDB = new tipo_id('localhost', 'bddesercion', 'root', 'Sena2014');
...
<body><center><form method="post" action="inser-tipo_id.php" name="form">
    <input type="submit" value="insertar campo"> </form>   
    <form method="post" action="elim-tipo_id.php" name="form">
    <input type="submit" value="eliminar campo"> </form>
    <form method="post" action="modi-tipo_id.php" name="form">
    <input type="submit" value="modificar campo"> </form>

    
<table border='2' align="center">

  <tr><th>cod_tipo_id</th>   
  <th>des_tipo_id</th> 
    </tr>
    <?php foreach($arrData as $row): ?>
<tr><td align="center"><?php echo $row['cod_tipo_id']?></td><td><?php echo $row['des_tipo_id']?></td>
</tr>
<?php endforeach ?>
</table>
</center>
